...
//		contentPane.add(btnAddAccount);
		...
		btnTransferFunds.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(!GUIForm.transfer.isVisible())
				{
					GUIForm.transfer.setVisible(true);
				}
				else
				{
					JOptionPane.showMessageDialog(getComponent(0), "Already Opened", "Warning", 0);
		...
		btnTransferFunds.setBounds(217, 300, 194, 33);
		contentPane.add(btnTransferFunds);
		...
		btnDisplayAccountList.setBounds(217, 343, 194, 33);

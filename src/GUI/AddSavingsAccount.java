...
//				FileIO file=new FileIO();
				...
				try {
					...
					maxw=Double.parseDouble(textField_2.getText());
				} catch (NumberFormatException ex) {
					JOptionPane.showMessageDialog(getComponent(0), "Invalid data entered. Please enter valid numeric values.", "Error", JOptionPane.ERROR_MESSAGE);
				...
				if(ch==0)
				{
					...
					dispose();
						...
						JOptionPane.showMessageDialog(getComponent(0), ex.getMessage(), "Error", 0);
					}
				}
				else 
				{
